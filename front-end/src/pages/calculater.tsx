...
//                                         prefix="₹" suffix="" decimals={0} maxLabel="1Cr"
//                                     />
//                                     <SliderInput
...
//                                         prefix="" suffix="% p.a." decimals={1} maxLabel="30%"
//                                     />
//                                     <SliderInput
//                                         label="Loan Duration"
//                                         value={duration}
...
//                                         min={1} max={30} step={1}
//                                         prefix="" suffix=" Yr" decimals={0} maxLabel="30 Yr"
//                                     />
//                                 </div>
//                             </div>
...
//                                             </ResponsiveContainer>
//                                             {/* Center label */}
//                                             <div className="position-absolute text-center" style={{ top: "50%", left: "50%", transform: "translate(-50%, -52%)", pointerEvents: "none", zIndex: 10 }}>
...
// function SliderInput({ label, value, onChange, min, max, step, prefix, suffix, decimals, maxLabel }: SliderInputProps) {
...
//                 <span className="fw-medium flex-grow-1 lc-slider-label">{label}</span>
//                 <div className="lc-type-box d-flex align-items-center rounded-2 px-2 py-1">
//                     {prefix && <span className="fw-bold text-white" style={{ fontSize: 16 }}>{prefix}</span>}
//                     <input
...
//                         }}
//                         onFocus={() => { isFocused.current = true; setInputVal(""); inputValRef.current = ""; }}
//                         onBlur={() => { isFocused.current = false; commitValue(inputValRef.current); }}
//                         onKeyDown={e => { if (e.key === "Enter") e.currentTarget.blur(); }}
//                     />
//                     {suffix && <span className="text-white text-nowrap lc-suffix-gap">{suffix}</span>}
//                 </div>
//             </div>
